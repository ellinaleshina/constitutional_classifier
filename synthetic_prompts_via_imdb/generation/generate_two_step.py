...
def generate_prompts(llm, topic="director Quentin Tarantino", temperature_q=1.2, temperature_p=0.7):
...
for i in range(10):
    ...
    prompts = generate_prompts(llm, topic=topic, temperature_q=1.2, temperature_p=0.7)
    ic(topic, prompts)
